...
class QQDashboardService:
    ...
    async def save_settings(
        ...
        *,
        ...
        buffer_delay_sigma_seconds: Optional[float] = None,
        buffer_delay_sigma_private_seconds: Optional[float] = None,
        buffer_delay_min_seconds: Optional[float] = None,
        buffer_delay_max_seconds: Optional[float] = None,
        ...
        try:
            result = await self.plugin.settings_service.save_settings(
                ...
                buffer_delay_sigma_seconds=buffer_delay_sigma_seconds,
                buffer_delay_sigma_private_seconds=buffer_delay_sigma_private_seconds,
                buffer_delay_min_seconds=buffer_delay_min_seconds,
                buffer_delay_max_seconds=buffer_delay_max_seconds,
